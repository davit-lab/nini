...
export const Route = createFileRoute("/portfolio/$slug")({
  ...
  notFoundComponent: () => (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6">
      ...
      <h1 className="mt-4 text-5xl font-display font-black uppercase">Project not found</h1>
      <Link to="/portfolio" className="mt-8 text-primary underline">Back to portfolio</Link>
    </div>
  ),
      ...
      <div className="max-w-[1800px] mx-auto px-5 md:px-10">
        ...
        <header className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4 lg:items-end lg:text-right">
            {data.date_label && (
              <div>
                <div className="micro-label opacity-60">Date</div>
                <div className="mt-2 font-display font-bold uppercase">{data.date_label}</div>
              </div>
            )}
            <div>
              <div className="micro-label opacity-60">Category</div>
        ...
        {data.description && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-20 max-w-[1400px]">
            <div className="lg:col-span-4">
              <span className="micro-label">About this project</span>
            </div>
