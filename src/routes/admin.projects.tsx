...
function ProjectsAdmin() {
  ...
  const { data: projects = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      return (data ?? []).map((d) => ({ ...d, gallery: (d.gallery as unknown as string[]) ?? [] })) as Project[];
    },
  });
    ...
    <div>
      <div className="flex items-center justify-between mb-12">
        <div>
          ...
          <h1 className="mt-3 text-5xl font-display font-black uppercase tracking-editorial">Projects</h1>
        </div>
            ...
            <div className="aspect-[4/5] relative overflow-hidden bg-secondary">
              ...
              {p.featured && (
                <span className="absolute top-3 left-3 micro-label glass px-2.5 py-1 rounded-full flex items-center gap-1">
                  <Star size={10} className="fill-primary text-primary" /> Featured
                </span>
              )}
            ...
            <div className="w-full max-w-3xl bg-card rounded-3xl border border-border p-8" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <div className="space-y-4">
                  ...
                  <Field label="Slug (URL)" hint="auto">
                  ...
                  <Field label="Date label" hint="optional">
              ...
              <div className="mt-5">
                <Field label="Gallery" hint="გადაათრიე რიგისთვის">
