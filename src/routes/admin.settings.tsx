  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-12">
        <div>
          <span className="micro-label">Site</span>
          <h1 className="mt-3 text-5xl font-display font-black uppercase tracking-editorial">Settings</h1>
        </div>
      ...
      <div className="space-y-10 max-w-3xl">
        <section>
          <h2 className="text-xs font-mono uppercase tracking-wider text-primary mb-4">Hero</h2>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Field label="Title — Part 2 (italic)">
        ...
        <section>
          <h2 className="text-xs font-mono uppercase tracking-wider text-primary mb-4">About</h2>
        ...
        <section>
          <h2 className="text-xs font-mono uppercase tracking-wider text-primary mb-4">Contact</h2>
          <div className="grid md:grid-cols-2 gap-4">
