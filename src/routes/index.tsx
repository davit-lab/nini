  ...
  return (
    <div className="relative w-full overflow-x-hidden">
        ...
        >
          ...
          >
            ...
            <div className="flex gap-12 md:gap-20">
              <div>
                <div className="micro-label opacity-60">Base</div>
                <div className="mt-2 font-display font-bold uppercase text-lg md:text-xl">
                  {settings?.contact_location || "Tbilisi, GE"}
                </div>
              </div>
              <div>
                <div className="micro-label opacity-60">Est.</div>
                <div className="mt-2 font-display font-bold uppercase text-lg md:text-xl">2024</div>
              </div>
              <div className="hidden md:block">
                <div className="micro-label opacity-60">Frames</div>
        ...
        <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div className="lg:sticky lg:top-32 flex flex-col gap-8">
            ...
            <h2 className="text-5xl md:text-7xl font-display font-black uppercase tracking-editorial leading-[0.85]">
              The <span className="accent-font italic font-normal text-primary lowercase">Art</span> of <br />
              Authenticity
            </h2>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-20">
            <div>
              ...
              <h2 className="mt-6 text-5xl md:text-7xl font-display font-black uppercase tracking-editorial">
                Featured <br />
                <span className="accent-font italic font-normal text-primary lowercase">projects</span>
              </h2>
            </div>
            <Link
              to="/portfolio"
      ...
      <section className="px-5 md:px-10 py-32 md:py-48 border-t border-border-subtle">
        <div className="max-w-[1800px] mx-auto">
          <div className="flex flex-col items-center text-center mb-20">
            <span className="micro-label">03 / Expertise</span>
            <h2 className="mt-6 text-6xl md:text-[10vw] font-display font-black uppercase leading-[0.8] tracking-editorial">
              My <span className="accent-font italic font-normal text-primary lowercase">services</span>
            </h2>
          </div>
      ...
      <section className="px-5 md:px-10 py-32 md:py-48">
        <div className="max-w-[1800px] mx-auto">
          <div className="flex flex-col items-center text-center mb-20">
            <span className="micro-label">04 / Archive</span>
            <h2 className="mt-6 text-6xl md:text-[10vw] font-display font-black uppercase leading-[0.8] tracking-editorial">
              The <span className="accent-font italic font-normal text-primary lowercase">portfolio</span>
            </h2>
      ...
      <section className="px-5 md:px-10 py-32 md:py-48 bg-card border-y border-border-subtle">
        <div className="max-w-[1800px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              <span className="micro-label">05 / Words</span>
              <h2 className="mt-6 text-5xl md:text-7xl font-display font-black uppercase tracking-editorial">
                Client <br />
                <span className="accent-font italic font-normal text-primary lowercase">stories</span>
              </h2>
            </div>
          </div>
