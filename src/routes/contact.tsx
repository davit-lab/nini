...
import { fetchSettings, fetchServices } from "@/lib/supabase-queries";
      ...
      <div className="max-w-[1800px] mx-auto px-5 md:px-10">
        <header className="mb-20">
          ...
          <h1 className="mt-6 text-6xl md:text-[12vw] font-display font-black uppercase leading-[0.8] tracking-editorial">
            Get in <br />
            <span className="accent-font italic font-normal text-primary lowercase">touch</span>
          </h1>
        </header>
            ...
            <div className="flex flex-col gap-5">
              {settings?.contact_email && (
                <a href={`mailto:${settings.contact_email}`} className="flex items-center gap-4 group">
                  ...
                  <div>
                    <div className="micro-label opacity-60">Email</div>
              ...
              {settings?.contact_phone && (
                <a href={`tel:${settings.contact_phone}`} className="flex items-center gap-4 group">
                  ...
                  <div>
                    <div className="micro-label opacity-60">Phone</div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="micro-label opacity-60">Location</div>
                  <div className="mt-1 font-display font-bold">{settings?.contact_location ?? "Tbilisi, GE"}</div>
                </div>
              </div>
            </div>
          </div>
